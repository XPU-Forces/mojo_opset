...
@pytest.mark.api("modules.RoPECosSin", ops=["rope_cos_sin"])
...
@pytest.mark.api("modules.VisionRoPECosSin2D", ops=["vision_rope_cos_sin_2d"])
...
def test_vision(accuracy_backend, grid):
    ...
    expected = modules.VisionRoPECosSin2D(
