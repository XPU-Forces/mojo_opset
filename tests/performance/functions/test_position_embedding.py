...
def test_rope(benchmark, perf_environment, batch, seq_len, q_heads, k_heads, phase):
    ...
    def factory():
        ...
        call = lambda: functions.rope(q, k, cos, sin, unsqueeze_dim=0, implementation=implementation)
