...
#   NODE0_IP: container/node0 communication IP
#   NODE1_IP: container/node1 communication IP
NODE0_IP="${NODE0_IP:-${LOCAL_HOST:-}}"
NODE1_IP="${NODE1_IP:-}"
...
export LOCAL_HOST="${LOCAL_HOST:-$NODE0_IP}"
export NODE_RANK=0

# Container/node0 uses the first 8 visible/global NPU devices by default.
...
export HCCL_IF_IP="${HCCL_IF_IP:-$NODE0_IP}"
