...
class IxformerResidualAddRMSNorm(MojoResidualAddRMSNorm):
    ...
    def forward(self, hidden_state: torch.Tensor, residual: torch.Tensor):
        ...
        if not hidden_state.is_cuda:
            raise RuntimeError("IxformerResidualAddRMSNorm expects CUDA tensors on Iluvatar.")
...
class IxformerResidualAddLayerNorm(MojoResidualAddLayerNorm):
    ...
    def forward(self, hidden_state: torch.Tensor, residual: torch.Tensor):
        ...
        if not hidden_state.is_cuda:
            raise RuntimeError("IxformerResidualAddLayerNorm expects CUDA tensors on Iluvatar.")
...
class IxformerLayerNorm(MojoLayerNorm):
    ...
    def forward(self, hidden_state: torch.Tensor) -> torch.Tensor:
        ...
        if not hidden_state.is_cuda:
            raise RuntimeError("IxformerLayerNorm expects CUDA tensors on Iluvatar.")
...
class IxformerRMSNorm(MojoRMSNorm):
    ...
    def forward(self, hidden_state: torch.Tensor) -> torch.Tensor:
        ...
        if not hidden_state.is_cuda:
            raise RuntimeError("IxformerRMSNorm expects CUDA tensors on Iluvatar.")
