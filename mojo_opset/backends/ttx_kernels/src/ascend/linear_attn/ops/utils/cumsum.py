...
from mojo_opset.backends.ttx_kernels.src.ascend.linear_attn.utils import check_shared_mem, input_guard
...
# @triton.autotune(
#     configs=[triton.Config({}, num_warps=num_warps, num_stages=1) for num_warps in [1, 2, 4]],
