...
from mojo_opset.backends.ttx_kernels.src.ascend.linear_attn.ops.utils.op import make_tensor_descriptor
from mojo_opset.backends.ttx_kernels.src.ascend.linear_attn.utils import input_guard, is_amd, is_tma_supported
