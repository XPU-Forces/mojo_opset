...
def top_k_sampling_impl(
    ...
    while current_groups > 1:
        ...
        next_sorted_vals = torch.full((batch_size, next_sorted_row_stride), pad_val, device=device,
                                      dtype=logits.dtype).contiguous()
        next_sorted_idx = torch.zeros((batch_size, next_sorted_row_stride), device=device,
