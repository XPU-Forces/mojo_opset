...
padded_window_attention_infer_impl = _get_kernel_impl(ttx_backend_module, "padded_window_attention_infer_impl")
...
if os.getenv("MOJO_RUN_MODE", "EAGER") == "COMPILE":
    ...
    padded_window_attention = padded_window_attention_infer_impl
