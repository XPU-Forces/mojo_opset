...
class MojoBackendRegistry:
    def __init__(self, core_op_cls: MojoKernel):
        ...
        self._registry: Dict[str, MojoKernel] = {}

    def get_core_op_cls(self):
        return self._core_op_cls

    def register(self, cls: MojoKernel):
    ...
    def get(self, backend_name: str = None) -> MojoKernel:
        ...
        print("!!!!!", backend_name, self._registry)
