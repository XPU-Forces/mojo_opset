...
@torch.library.custom_op("mojo_npu_triton_a5::apply_rope_fwd", mutates_args=())
def apply_rope_fwd(
...
@torch.library.custom_op("mojo_npu_triton_a5::apply_rope_bwd", mutates_args=())
def apply_rope_bwd(
...
@torch.library.custom_op("mojo_npu_triton_a5::apply_rope_infer_fwd", mutates_args=())
