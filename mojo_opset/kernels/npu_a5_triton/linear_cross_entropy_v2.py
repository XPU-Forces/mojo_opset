...
@torch.library.custom_op("mojo_npu_triton_a5::linear_cross_entropy_v2_fwd", mutates_args=())
...
@linear_cross_entropy_v2_fwd.register_fake
def _linear_cross_entropy_v2_fwd_fake(
    inputs: torch.Tensor, weight: torch.Tensor, labels: torch.Tensor, ignore_index: int,
    z_loss_weight: float, calc_acc: bool, align_precision: bool,
) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
...
@torch.library.custom_op("mojo_npu_triton_a5::linear_cross_entropy_v2_bwd", mutates_args=())
...
@linear_cross_entropy_v2_bwd.register_fake
def _linear_cross_entropy_v2_bwd_fake(
    grad_loss: torch.Tensor, inputs: torch.Tensor, weight: torch.Tensor, labels: torch.Tensor,
    lse: torch.Tensor, lse_abs: torch.Tensor, ignore_index: int, z_loss_weight: float,
) -> tuple[torch.Tensor, torch.Tensor]:
...
@torch.library.custom_op(
    "mojo_npu_triton_a5::linear_cross_entropy_v2_and_zloss_fwd",
    mutates_args=(),
)
def linear_cross_entropy_v2_and_zloss_fwd(
    inputs: torch.Tensor,
    weight: torch.Tensor,
    labels: torch.Tensor,
    ignore_index: int,
...
@linear_cross_entropy_v2_and_zloss_fwd.register_fake
def _linear_cross_entropy_v2_and_zloss_fwd_fake(
    inputs: torch.Tensor,
    weight: torch.Tensor,
    labels: torch.Tensor,
    ignore_index: int,
...
@torch.library.custom_op(
    "mojo_npu_triton_a5::linear_cross_entropy_v2_and_zloss_bwd",
    mutates_args=(),
)
def linear_cross_entropy_v2_and_zloss_bwd(
    grad_loss: torch.Tensor,
    inputs: torch.Tensor,
    weight: torch.Tensor,
    labels: torch.Tensor,
...
@linear_cross_entropy_v2_and_zloss_bwd.register_fake
def _linear_cross_entropy_v2_and_zloss_bwd_fake(
    grad_loss: torch.Tensor,
    inputs: torch.Tensor,
    weight: torch.Tensor,
    labels: torch.Tensor,
