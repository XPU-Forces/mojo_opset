...
@torch.library.custom_op("mojo_npu_triton_a5::swa_infer", mutates_args=())
def swa_infer_fwd(
...
@torch.library.custom_op("mojo_npu_triton_a5::swa_preprocess", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a5::swa_dkdv", mutates_args=())
def swa_dkdv(
    do: torch.Tensor,
    delta: torch.Tensor,
    q: torch.Tensor,
...
@torch.library.custom_op("mojo_npu_triton_a5::swa_dq", mutates_args=())
def swa_dq(
    do: torch.Tensor,
    delta: torch.Tensor,
    q: torch.Tensor,
...
@torch.library.custom_op("mojo_npu_triton_a5::paged_prefill_swa_infer_fwd", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a5::paged_decode_swa_infer_fwd", mutates_args=())
