...
def _silu_bwd_flatten_kernel(
    ...
    for block_id in range(block_start, block_end):
        ...
        # Round only at the destination, including mixed BF16 dy / FP32 x.
...
@torch.library.custom_op("mojo_npu_triton_a5::silu_fwd", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a5::silu_bwd", mutates_args=())
