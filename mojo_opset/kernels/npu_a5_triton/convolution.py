...
@torch.library.custom_op("mojo_npu_triton_a5::causal_conv1d_forward", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a5::causal_conv1d_state", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a5::causal_conv1d_backward", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a5::causal_conv1d_state_backward", mutates_args=())
