...
MASK_BLOCK_SIZE = TILE_BLOCK_SIZE
...
@torch.library.custom_op("mojo_npu_triton_a5::flex_attention_v2_forward", mutates_args=("outputs",))
...
@torch.library.custom_op("mojo_npu_triton_a5::flex_attention_v2_dq", mutates_args=("outputs",))
...
@torch.library.custom_op("mojo_npu_triton_a5::flex_attention_v2_dkdv", mutates_args=("outputs",))
