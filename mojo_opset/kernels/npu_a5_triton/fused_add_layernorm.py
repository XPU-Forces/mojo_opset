...
@torch.library.custom_op("mojo_npu_triton_a5::residual_add_layer_norm_infer", mutates_args=())
def residual_add_layer_norm_infer_fwd(
    ...
    return fused_add_layernorm_infer_impl(
        x.contiguous(), residual.contiguous(), weight.contiguous(), bias.contiguous(), "pre", eps
    )
