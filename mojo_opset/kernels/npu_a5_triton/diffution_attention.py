...
@torch.library.custom_op("mojo_npu_triton_a5::diffusion_fwd_up_leaf", mutates_args=('o', 'fp32o', 'lse'))
...
@torch.library.custom_op("mojo_npu_triton_a5::diffusion_fwd_down_leaf", mutates_args=('o', 'fp32o', 'lse'))
...
@torch.library.custom_op("mojo_npu_triton_a5::diffusion_bwd_d_leaf", mutates_args=('d',))
...
@torch.library.custom_op("mojo_npu_triton_a5::diffusion_bwd_q_up_leaf", mutates_args=('dq',))
...
@torch.library.custom_op("mojo_npu_triton_a5::diffusion_bwd_q_down_leaf", mutates_args=('dq',))
...
@torch.library.custom_op("mojo_npu_triton_a5::diffusion_bwd_kv_left_leaf", mutates_args=("dk", "dv"))
...
@torch.library.custom_op("mojo_npu_triton_a5::diffusion_bwd_kv_right_leaf", mutates_args=("dk", "dv"))
