...
@torch.library.custom_op("mojo_npu_triton_a2::rms_norm_fwd", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a2::rms_norm_bwd_partial", mutates_args=())
def rms_norm_bwd_partial(
    ...
    if cols <= COL_BLOCKING_THRESHOLD:
        ...
        _rmsnorm_bwd_large_cols_kernel[(num_programs,)](
            *args, BLOCK_SIZE_N=COL_BLOCKING_THRESHOLD, BLOCK_SIZE_M=2,
        )
...
@torch.library.custom_op("mojo_npu_triton_a2::rms_norm_dw_reduce", mutates_args=())
...
def rms_norm_bwd(
    ...
    large = cols > COL_BLOCKING_THRESHOLD
    if large:
...
@torch.library.custom_op("mojo_npu_triton_a2::rms_norm_infer", mutates_args=())
