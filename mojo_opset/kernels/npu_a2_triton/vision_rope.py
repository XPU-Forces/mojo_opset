...
@torch.library.custom_op("mojo_npu_triton_a2::vision_rope_2d_infer", mutates_args=("q", "k"))
...
@torch.library.custom_op("mojo_npu_triton_a2::vision_rope_cos_sin_2d_fwd", mutates_args=())
