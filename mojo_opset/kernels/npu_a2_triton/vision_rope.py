...
from mojo_opset.kernels._npu_triton_utils import SRAM_ALIGN_BYTES
...
@torch.library.custom_op("mojo_npu_triton_a2::apply_vision_rope2d_infer", mutates_args=("q", "k"))
...
@_vision_rope_leaf.register_fake
def _vision_rope_fake(q, k, cos, sin):
    return None
...
@torch.library.custom_op("mojo_npu_triton_a2::vision_rotary_embedding2d_fwd", mutates_args=())
