...
@torch.library.custom_op(
    "mojo_npu_triton_a2::linear_cross_entropy_reduce", mutates_args=(),
...
@torch.library.custom_op(
    "mojo_npu_triton_a2::linear_cross_entropy_none", mutates_args=(),
    schema="(Tensor inputs, Tensor weight, Tensor target, Tensor? bias, Tensor? ce_weight, int ignore_index, "
...
@torch.library.custom_op(
    "mojo_npu_triton_a2::linear_cross_entropy_none_backward", mutates_args=(),
