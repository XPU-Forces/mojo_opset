...
@torch.library.custom_op("mojo_npu_triton_a2::linear_cross_entropy_fwd", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a2::linear_cross_entropy_bwd", mutates_args=())
...
@torch.library.custom_op(
    "mojo_npu_triton_a2::linear_cross_entropy_and_zloss_fwd",
    mutates_args=(),
)
...
@torch.library.custom_op(
    "mojo_npu_triton_a2::linear_cross_entropy_and_zloss_bwd",
    mutates_args=(),
)
