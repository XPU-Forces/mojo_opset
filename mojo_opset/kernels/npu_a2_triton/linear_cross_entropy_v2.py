...
@torch.library.custom_op("mojo_npu_triton_a2::linear_cross_entropy_v2_fwd", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a2::linear_cross_entropy_v2_bwd", mutates_args=())
...
@torch.library.custom_op(
    "mojo_npu_triton_a2::linear_cross_entropy_v2_and_zloss_fwd",
    mutates_args=(),
)
...
@torch.library.custom_op(
    "mojo_npu_triton_a2::linear_cross_entropy_v2_and_zloss_bwd",
    mutates_args=(),
)
