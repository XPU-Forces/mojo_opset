...
@torch.library.custom_op("mojo_npu_triton_a2::static_quant_fwd", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a2::dequant_fwd", mutates_args=())
...
@torch.library.custom_op("mojo_npu_triton_a2::dynamic_quant_fwd", mutates_args=())
