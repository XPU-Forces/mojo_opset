...
@torch.library.custom_op("mojo_npu_triton_a2::flex_attention_forward", mutates_args=("outputs",))
...
@torch.library.custom_op("mojo_npu_triton_a2::flex_attention_dq", mutates_args=("outputs",))
...
@torch.library.custom_op("mojo_npu_triton_a2::flex_attention_dkdv", mutates_args=("outputs",))
...
@torch.library.custom_op("mojo_npu_triton_a2::flex_attention_dkdv_tasklist", mutates_args=("outputs",))
...
@torch.library.custom_op("mojo_npu_triton_a2::flex_attention_reduce_tasklist", mutates_args=("outputs",))
