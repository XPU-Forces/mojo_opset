...
GROUP_FUSED_MAX_COLS = COL_BLOCKING_THRESHOLD
...
def group_rmsnorm_impl(
    ...
    # Four group weights and their row-wise selection need more UB than a
    # standalone RMS launch. The inherited tile overflows A2 UB at D=2048.
    if N >= GROUP_FUSED_MAX_COLS:
        BLOCK_SIZE_M = 1
...
@torch.library.custom_op("mojo_npu_triton_a2::group_rms_norm_infer", mutates_args=())
